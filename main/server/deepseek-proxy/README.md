...
This Cloudflare Worker keeps the AI provider key out of the iOS app. The app calls `/invoke-llm`, the Worker checks the configured client header, then forwards the prompt to the configured provider model for the user's access tier.
