...
enum LocalizationStrings {
    static let ja: [String: String] = [
        ...
        "For subscriptions outside the App Store, add them manually so ClearSpend can renew them for you.": "App Store以外のサブスクは手動で追加すると、ClearSpendが次回以降を自動で記録します。",
    ...
    static let zh: [String: String] = [
        ...
        "For subscriptions outside the App Store, add them manually so ClearSpend can renew them for you.": "App Store 之外的订阅可以手动添加，之后 ClearSpend 会自动记录续费。",
