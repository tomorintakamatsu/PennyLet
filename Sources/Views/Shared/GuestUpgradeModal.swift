    ...
    var body: some View {
        NavigationStack {
            VStack(spacing: 24) {
                ...
                Text(viewModel.loc("To upgrade to ClearSpend Pro, you need an account. Your data will be saved and synced across devices."))
                ...
                VStack(spacing: 12) {
                    ...
                    Button {
                        ...
                        .frame(maxWidth: .infinity)
                        .padding(.vertical, 14)
                        .background(viewModel.theme.primaryColor, in: RoundedRectangle(cornerRadius: 14))
                    }
