...
#ifndef CLEARSPEND_SWIFT_H
#define CLEARSPEND_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ClearSpend",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class NSData;
SWIFT_CLASS("_TtC10ClearSpend11AppDelegate")
...
SWIFT_CLASS("_TtC10ClearSpend19AppleSignInDelegate")
...
SWIFT_CLASS("_TtC10ClearSpend24AuthPresentationProvider")
@interface AuthPresentationProvider : NSObject <ASAuthorizationControllerPresentationContextProviding, ASWebAuthenticationPresentationContextProviding>
...
SWIFT_CLASS("_TtC10ClearSpend19NotificationService")
