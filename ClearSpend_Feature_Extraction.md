# ClearSpend Feature Extraction Brief
...
- Xcode target/scheme: one application target named ClearSpend.
- Signing: automatic signing, Apple Sign In entitlement enabled.
- URL scheme: clearspend.
- Assets:
...
- Friendly name mapping for common services such as YouTube Premium, Spotify, Netflix, Disney+, Hulu, Max, Apple services, iCloud+, Amazon Prime, Tinder, Bumble, Strava, Peloton, Calm, Headspace, Duolingo, Adobe, Microsoft 365, Dropbox, Google One, Notion, Todoist, Evernote, Fantastical, and ClearSpend Pro.
...
- Camera usage: ClearSpend uses your camera to scan receipts.
- Microphone usage: ClearSpend uses your microphone for voice input.
- Speech recognition usage: ClearSpend uses speech recognition to transcribe your voice input.
...
- Privacy Policy: https://tomorintakamatsu.github.io/clearspend-privacy/privacy-policy.pdf
